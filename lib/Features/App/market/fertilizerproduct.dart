...
class FertilizerProduct extends StatelessWidget {
  final String productId;
  final Color primaryGreen = const Color(0xFF2E7D32);
  final Color lightGreen = const Color(0xFF4CAF50);

  const FertilizerProduct({Key? key, required this.productId})
      : super(key: key);
        ...
        builder: (context, snapshot) {
          ...
          if (!product.containsKey('productId')) {
            ...
            FirebaseFirestore.instance
                ...
                .then((_) => print('Added productId to product document'))
                .catchError(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              OutlinedButton.icon(
                                ...
                                icon: Icon(Icons.comment, color: primaryGreen),
                                label: Text(
