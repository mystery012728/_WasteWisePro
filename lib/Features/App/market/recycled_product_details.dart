...
class RecycledProductDetailPage extends StatelessWidget {
  ...
  const RecycledProductDetailPage({Key? key, required this.productId})
      : super(key: key);
        ...
        builder: (context, snapshot) {
          ...
          if (!product.containsKey('productId')) {
            ...
            FirebaseFirestore.instance
                ...
                .then((_) =>
                print('Added productId to recycled product document'))
                .catchError(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              OutlinedButton.icon(
                                ...
                                icon: Icon(Icons.comment, color: primaryBlue),
                                label: Text(
                      ...
                      child: _buildButton(
                        ...
                        onPressed: () {
                          Provider.of<CartProvider>(context, listen: false)
                            ...
                            'quantity': 1,
                            'category':
                            'recycled_craft', // Add category for later identification
                          });
